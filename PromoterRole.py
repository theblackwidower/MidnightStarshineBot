    ...
    if message.author.permissions_in(message.channel).manage_guild:
        ...
        try:
            ...
            if serverData[0] > 0:
                ...
                await message.channel.send("Promoter role feature completely cleared out. If you want to reenable it, please run `" + getPrefix(message.guild) + SETUP_PROMOTER_ROLE_COMMAND + "` again.")
            else:
